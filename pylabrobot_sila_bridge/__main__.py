...
"""Console script for pylabrobot_sila_bridge."""
...
def parse_command_line():
    ...
    description = "pylabrobot_sila_bridge"
...
def main():
    ...
    print("Replace this message by putting your code into pylabrobot_sila_bridge.__main__")
